...
import { Smiley, Sparkle } from "./Doodles";
    ...
    >
      ...
      <div style={{ width: "100%", maxWidth: 860, textAlign: "center", position: "relative", zIndex: 1 }}>
        ...
        >
          ...
          <h2 className="font-display" style={{ fontSize: "clamp(2rem, 5vw, 3rem)", fontWeight: 700, color: "#1B2A4A" }}>
            let&apos;s connect!
          </h2>
        </motion.div>
        ...
        <motion.p
          ...
          style={{ color: "rgba(27,42,74,0.6)", fontSize: 18, maxWidth: 480, margin: "0 auto 40px", lineHeight: 1.7 }}
        >
          always down to chat about new projects, creative ideas, or just say hi!
          my inbox is open <Sparkle className="text-pink" />
        </motion.p>
            ...
            <MagneticButton key={social.name}>
              <motion.a
                ...
                style={{
                  ...
                  boxShadow: `3px 3px 0 ${social.border}`,
                  textDecoration: "none",
                  transition: "all 0.2s",
                }}
              >
        ...
        <div style={{ marginTop: 96, fontSize: 14, fontWeight: 700, color: "rgba(27,42,74,0.3)" }}>
